...
INSERT INTO "Events" ("id", "name", "description", "date", "available_places", "user_list")
VALUES
    ('b2c3d4e5-f678-9012-3456-789abcdef123', 'Startup Pitch Night', 'An opportunity for startups to present their ideas to investors.', '2025-07-10', 30, ARRAY[]::json),
    ('c3d4e5f6-7890-1234-5678-9abcdef12345', 'AI Workshop', 'Hands-on workshop on building AI-powered applications.', '2025-08-20', 20, ARRAY[
